...
async function sabar(x) {
    try {
        ...
        const { original_title, popularity, poster_path, runtime } = tj;  //6.3 reduced js object WITH ONLY CERTAIN PROPS
        const mj = { original_title, popularity, poster_path,runtime};
        ...
        <p id="yr">${mj.popularity}</p>
        <p id="yr">${mj.runtime} min</p>
